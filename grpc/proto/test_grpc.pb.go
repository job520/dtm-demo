...
type TestClient interface {
	TransIn(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error)
	TransInCompensate(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error)
	TransOut(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error)
	TransOutCompensate(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error)
}
...
func (c *testClient) TransIn(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
...
func (c *testClient) TransInCompensate(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
...
func (c *testClient) TransOut(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
...
func (c *testClient) TransOutCompensate(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
...
type TestServer interface {
	TransIn(context.Context, *TestRequest) (*TestResponse, error)
	TransInCompensate(context.Context, *TestRequest) (*TestResponse, error)
	TransOut(context.Context, *TestRequest) (*TestResponse, error)
	TransOutCompensate(context.Context, *TestRequest) (*TestResponse, error)
...
func (UnimplementedTestServer) TransIn(context.Context, *TestRequest) (*TestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransIn not implemented")
}
func (UnimplementedTestServer) TransInCompensate(context.Context, *TestRequest) (*TestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransInCompensate not implemented")
}
func (UnimplementedTestServer) TransOut(context.Context, *TestRequest) (*TestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransOut not implemented")
}
func (UnimplementedTestServer) TransOutCompensate(context.Context, *TestRequest) (*TestResponse, error) {
...
func _Test_TransIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).TransIn(ctx, req.(*TestRequest))
	}
...
func _Test_TransInCompensate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).TransInCompensate(ctx, req.(*TestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Test_TransOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).TransOut(ctx, req.(*TestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Test_TransOutCompensate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).TransOutCompensate(ctx, req.(*TestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
